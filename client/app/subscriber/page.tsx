...
const Page = () => {
  ...
  // const claimId = (data: any  ) => {
  //   const url = "https://b2a5-208-123-173-93.ngrok-free.app/claim-identity";
  //   const body ={
  //     "credentialSchema": "https://raw.githubusercontent.com/gendev1/zk-subs/main/schema/maskd.json",
  //     "type": "usersubscription",
  //     "credentialSubject": {
  //       "id": "<<fill with user generated did>>",
  //       "stream-details": {<<fill in the details>>},
  //       "documentType": 2
  //     },
  ...
  async function postIdentity() {
    const url = "http://localhost:3001/run-zokrates";
    const body = {
      id: uuidv4(),
      providerId: count,
      address: address,
